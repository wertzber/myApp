...
(function (H, u, Sa) {
    ...
    var M = u.noop, Aa = u.extend, L = u.element, q = u.forEach, X = u.isArray, I = u.isString, pa = u.isObject, qa = u.isUndefined, V = u.isDefined, Fa = u.isFunction, ra = u.isElement, O, sa, U, ta;
    ...
    }, Qa = {transitionDuration: H, transitionDelay: fa, animationDuration: ua, animationDelay: ka};
    u.module("ngAnimate",
        []).directive("ngAnimateChildren", [function () {
            ...
            d.prototype = {
                ...
                }, progress: M, getPromise: function () {
                    if (!this.promise) {
                        var b = this;
            ...
            this.$get = ["$$rAF", "$rootScope", "$rootElement", "$document", "$$HashMap", "$$animation", "$$AnimateRunner", "$templateRequest", "$$jqLite",
                "$$forceReflow", function (d, s, h, g, v, r, $, u, R, C) {
                    ...
                    function l(a, f, k) {
                        ...
                        if (g)return t(), h;
                        l && y(a);
                        g = {structural: l, element: a, event: f, close: t, options: k, runner: h};
                        if (C) {
                            if (b("skip", a, g, z)) {
                            ...
                            if (b("cancel", a, g, z))if (2 === z.state)z.runner.end(); else if (z.structural)z.close(); else return Q(a, z.options, g.options), z.runner;
                    ...
                    function la(a, b, c) {
                        c = L(g[0].body);
                        var d = f(a, c) || "HTML" === a[0].nodeName, t = f(a, h), n = !1, w;
            ...
            this.$get = ["$$jqLite", "$rootScope", "$injector", "$$AnimateRunner", "$$HashMap", "$$rAFScheduler", function (a, e, s, h, g, v) {
                function r(a) {
                    ...
                    for (d = 0; d < a.length; d++) {
                        var h = a[d];
                        e.put(h.domNode, a[d] = {domNode: h.domNode, fn: h.fn, children: []})
                    }
                ...
                return function (g, C, D) {
                        ...
                        q(a, function (a, f) {
                            ...
                            if (d.length) {
                                ...
                                q(d, function (a) {
                                    ...
                                    c[b] = c[b] || {};
                                    c[b][m] = {animationID: f, element: L(a)}
                                })
                            } else b.push(a)
                        });
                        var f = {}, d = {};
                                ...
                                if (!d[x]) {
                                    var A = d[x] = {
                                        ...
                                        close: function () {
                                            h.close();
                                            g.close()
                                        }, classes: y(h.classes, g.classes), from: h, to: g, anchors: []
                                    };
                    ...
                    $.push({
                        element: g, classes: G, event: C, structural: m, options: D, beforeStart: function () {
                    ...
                    e.$$postDigest(function () {
                        ...
                        q(c, function (a) {
                            d.push({
                                domNode: B(a.from ?
                                    a.from.element : a.element), fn: function () {
                                    a.beforeStart();
                                    var c, d = a.close;
            ...
            this.$get = ["$window", "$$jqLite", "$$AnimateRunner", "$timeout", "$$forceReflow", "$sniffer", "$$rAFScheduler", "$animate", function (a, e, s, h, g, v, r, u) {
                ...
                return function (a, c) {
                    ...
                    c = ia(c);
                    var y = [], r = a.attr("class"), l = Ia(c), ga, k, va, H, L, I, N, J, z;
                    ...
                    var Z = [Q, P].join(" ").trim(), ha = r + " " + Z, Y = T(Z, "-active"), r = l.to && 0 <
                    ...
                    return {
                        $$willAnimate: !0,
                            ...
                            if (!ga)return L = {end: d, cancel: g, resume: null, pause: null}, H = new s(L), C(A), H
                        }
                    }
                }
            }]
            ...
            this.$get = ["$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$sniffer", "$$jqLite", "$document", function (a, c, d, e, s, h, g) {
                ...
                function u(c, e, g) {
                    ...
                    var x =
                        L(B(e).cloneNode(!0)), m = v(x.attr("class") || "");
                    ...
                    var F;
                    c = function () {
                        var c = a(x, {addClass: "ng-anchor-out", delay: !0, from: h(e)});
            ...
            this.$get = ["$injector", "$$AnimateRunner", "$$jqLite", function (b, c, d) {
                ...
                return function (a, b, d, r) {
                    ...
                    var D = r.addClass, K = r.removeClass, l = e(d), y, w;
                    if (l.length) {
                        var f, I;
